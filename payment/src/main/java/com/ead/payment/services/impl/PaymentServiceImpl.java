...
import com.ead.payment.publishers.PaymentPublisherCommand;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Autowired
    private PaymentPublisherCommand paymentPublisherCommand;
    @Autowired
    ...
    public PaymentModel requestPayment(PaymentRequestDto paymentRequestDto, UserModel userModel) {
        ...
        try{
            ...
            paymentPublisherCommand.publishPaymentCommand(paymentCommandDto);
        }catch (Exception e){
    ...
    @Override
    public Page<PaymentModel> findByAllUser(Specification<PaymentModel> spec, Pageable pageable) {
