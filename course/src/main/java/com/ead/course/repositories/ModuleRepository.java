...
public interface ModuleRepository extends JpaRepository<ModuleModel, UUID> , JpaSpecificationExecutor<ModuleModel> {
    ...
    /*
    Como o carregamento dos course em module está pre definido para lazy(não acrrega a menos que solicitado),
    temos essa anotation @EntityGraph que faz o carregamento de course como se fosse um featch eager.
    */
